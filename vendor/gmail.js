...
/*custom*/
api.dom.reply_toolbar = function() {
    var tb = $(".gU.az5");
...
api.dom.reply_send_toolbar = function() {
    var tb = $(".gU.Up");
...
/*custom*/
  api.tools.make_introducr_request_async = function (link, method, headertosend, datatype, datatosend, callback) {
    var method  = (typeof method == undefined || typeof method == null) ? 'GET' : method;

    $.ajax({ type: method, url: encodeURI(link), async:true, dataType: datatype, data: datatosend, headers:headertosend})
      .done(function(data, textStatus, jqxhr) {
        callback(jqxhr.responseText);
      })
      .fail(function(jqxhr, textStatus, errorThrown) {
...
/*end*/
  ...
  /*custom*/
  api.tools.add_reply_toolbar_button = function(content_html, onClickFunction, styleClass) {
if($('.introducr_element_removable').length<=0){
    var container = $(document.createElement('div'));
    container.attr('class','G-Ni J-J5-Ji');
    ...
    api.dom.reply_toolbar().prepend(container);
    return container;
}
  }

  api.tools.add_reply_toolbar_sendbutton = function(content_html, onClickFunction, styleClass) {
    var container = $(document.createElement('div'));
    container.attr('class','G-Ni J-J5-Ji');
    ...
    button.attr('class', buttonClasses);
    button.attr('id','introducr_reply_sendbutton');
    ...
    api.dom.reply_send_toolbar().append(container);

    return container;
  }

  api.tools.add_top_icon = function(wrapper_class, onClickFunction, styleClass) {
    var container = $(document.createElement('div'));
    container.attr('class',wrapper_class);
    ...
    api.dom.top_menu().before(container);
  ...
  * @returns {boolean}
  */
  api.compose.introducr_reply = function() {
